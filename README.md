...
A step-by-step tutorial is also available in [Tutorial](https://github.com/ImproPhoto/pymicmac/tree/master/tutorial/TUTORIAL.md).
...
Autogenerated API documentation is available. [API Docs](https://github.com/ImproPhoto/pymicmac/tree/master/docs/_build/html/index.html).
